...
class PSAW<K, V> extends PSA<K, V> {
   ...
   PSAW(K var1, ReferenceQueue<K> var2, V var3, ReferenceQueue<V> var4, int var5, long var6) {
      super((K)var1, var2, (V)var3, var4, var5, var6);
      WRITE_TIME.set((PSAW)this, (long)(var6 & -2L));
   }

   PSAW(Object var1, V var2, ReferenceQueue<V> var3, int var4, long var5) {
      super(var1, (V)var2, var3, var4, var5);
      WRITE_TIME.set((PSAW)this, (long)(var5 & -2L));
   }
   ...
   public long getVariableTime() {
      return (long)WRITE_TIME.getOpaque((PSAW)this);
   }

   @Override
   public void setVariableTime(long var1) {
      WRITE_TIME.setOpaque((PSAW)this, (long)var1);
   }

   @Override
   public boolean casVariableTime(long var1, long var3) {
      return this.writeTime == var1 && WRITE_TIME.compareAndSet((PSAW)this, (long)var1, (long)var3);
   }
   ...
   public final void setWriteTime(long var1) {
      WRITE_TIME.set((PSAW)this, (long)var1);
   }
   ...
   public Node<K, V> newNode(K var1, ReferenceQueue<K> var2, V var3, ReferenceQueue<V> var4, int var5, long var6) {
      return new PSAW<>((K)var1, var2, (V)var3, var4, var5, var6);
   }

   @Override
   public Node<K, V> newNode(Object var1, V var2, ReferenceQueue<V> var3, int var4, long var5) {
      return new PSAW<>(var1, (V)var2, var3, var4, var5);
   }
   ...
   static {
      ...
      try {
         WRITE_TIME = var0.findVarHandle(PSAW.class, "writeTime", long.class);
