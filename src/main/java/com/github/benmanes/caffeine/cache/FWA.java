...
class FWA<K, V> extends FW<K, V> {
   ...
   FWA(K var1, ReferenceQueue<K> var2, V var3, ReferenceQueue<V> var4, int var5, long var6) {
      super((K)var1, var2, (V)var3, var4, var5, var6);
      ACCESS_TIME.set((FWA)this, (long)var6);
   }

   FWA(Object var1, V var2, ReferenceQueue<V> var3, int var4, long var5) {
      super(var1, (V)var2, var3, var4, var5);
      ACCESS_TIME.set((FWA)this, (long)var5);
   }
   ...
   public long getVariableTime() {
      return (long)ACCESS_TIME.getOpaque((FWA)this);
   }

   @Override
   public void setVariableTime(long var1) {
      ACCESS_TIME.setOpaque((FWA)this, (long)var1);
   }

   @Override
   public boolean casVariableTime(long var1, long var3) {
      return this.accessTime == var1 && ACCESS_TIME.compareAndSet((FWA)this, (long)var1, (long)var3);
   }
   ...
   public Node<K, V> newNode(K var1, ReferenceQueue<K> var2, V var3, ReferenceQueue<V> var4, int var5, long var6) {
      return new FWA<>((K)var1, var2, (V)var3, var4, var5, var6);
   }

   @Override
   public Node<K, V> newNode(Object var1, V var2, ReferenceQueue<V> var3, int var4, long var5) {
      return new FWA<>(var1, (V)var2, var3, var4, var5);
   }
   ...
   static {
      ...
      try {
         ACCESS_TIME = var0.findVarHandle(FWA.class, "accessTime", long.class);
