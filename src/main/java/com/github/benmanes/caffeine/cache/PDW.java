...
class PDW<K, V> extends PD<K, V> {
   ...
   PDW(K var1, ReferenceQueue<K> var2, V var3, ReferenceQueue<V> var4, int var5, long var6) {
      super((K)var1, var2, (V)var3, var4, var5, var6);
      WRITE_TIME.set((PDW)this, (long)(var6 & -2L));
   }

   PDW(Object var1, V var2, ReferenceQueue<V> var3, int var4, long var5) {
      super(var1, (V)var2, var3, var4, var5);
      WRITE_TIME.set((PDW)this, (long)(var5 & -2L));
   }
   ...
   public long getVariableTime() {
      return (long)WRITE_TIME.getOpaque((PDW)this);
   }

   @Override
   public void setVariableTime(long var1) {
      WRITE_TIME.setOpaque((PDW)this, (long)var1);
   }

   @Override
   public boolean casVariableTime(long var1, long var3) {
      return this.writeTime == var1 && WRITE_TIME.compareAndSet((PDW)this, (long)var1, (long)var3);
   }
   ...
   public final void setWriteTime(long var1) {
      WRITE_TIME.set((PDW)this, (long)var1);
   }
   ...
   public Node<K, V> newNode(K var1, ReferenceQueue<K> var2, V var3, ReferenceQueue<V> var4, int var5, long var6) {
      return new PDW<>((K)var1, var2, (V)var3, var4, var5, var6);
   }

   @Override
   public Node<K, V> newNode(Object var1, V var2, ReferenceQueue<V> var3, int var4, long var5) {
      return new PDW<>(var1, (V)var2, var3, var4, var5);
   }
   ...
   static {
      ...
      try {
         WRITE_TIME = var0.findVarHandle(PDW.class, "writeTime", long.class);
