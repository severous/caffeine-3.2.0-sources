...
final class PWARMW<K, V> extends PWAR<K, V> {
   ...
   PWARMW(K var1, ReferenceQueue<K> var2, V var3, ReferenceQueue<V> var4, int var5, long var6) {
      super((K)var1, var2, (V)var3, var4, var5, var6);
      this.weight = var5;
   }

   PWARMW(Object var1, V var2, ReferenceQueue<V> var3, int var4, long var5) {
   ...
   public Node<K, V> newNode(K var1, ReferenceQueue<K> var2, V var3, ReferenceQueue<V> var4, int var5, long var6) {
      return new PWARMW<>((K)var1, var2, (V)var3, var4, var5, var6);
   }

   @Override
   public Node<K, V> newNode(Object var1, V var2, ReferenceQueue<V> var3, int var4, long var5) {
      return new PWARMW<>(var1, (V)var2, var3, var4, var5);
   }
}
